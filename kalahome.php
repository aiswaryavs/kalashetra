...
<div class="dropdown">
 <button class="dropbtn">Login</button>
  <div class="dropdown-content">
	...
	<a href="patient_login.php">Student Login</a>
...
<h2><font color="red"><span style="color:red;font-family:Calibri Light (Headings)"><b><pre><MARQUEE>MaMaNgAM ThE WaY To FlY</MARQUEE></PRE></b></span></h1>
<body bgcolor=" white">

<ul>
 <h2> <li><a href="#contact">Contact</a></li></h2>
  <h2><li><a href="#news">News</a></li></h2>
   <h2><li><a href="reg.php">Register</a></li></h2>
   <h2><li><a href="home.php">Home</a></li></h2>
</ul>
<center> <img src="d6.jpg" width="923px" height="300px">
<h1><font color="red"><p>Lets Start Moving </p></h1>
